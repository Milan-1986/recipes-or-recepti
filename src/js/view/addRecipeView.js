...
class AddRecipeView extends View {
    ...
    toggleWindow() {
        ...
        // console.log(this.overlay.classList.contains('hidden'));
    ...
    #addHandlerShowWindow() {
        this.buttonOpen.addEventListener('click', this.toggleWindow.bind(this))

    }

    #addHandlerHideWindow() {
        this.buttonClose.addEventListener('click', this.toggleWindow.bind(this));
    ...
    generateMarkup() {
        ...
        <div class="upload__column">
            ...
            <input value="TEST123" required name="imageUrl" type="text" />
